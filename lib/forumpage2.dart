...
class ForumPage2 extends StatefulWidget {
  @override
  _ForumPage2State createState() => _ForumPage2State();
}

class _ForumPage2State extends State<ForumPage2> {
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;
  TextEditingController _postController = TextEditingController();

  void _addPost() {
    if (_postController.text.isNotEmpty) {
      _firestore.collection('posts2').add({
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Expanded(
            child: StreamBuilder(
              stream: _firestore.collection('posts2').orderBy('timestamp', descending: true).snapshots(),
